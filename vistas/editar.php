...
<body class="solicitud-body">
    ...
    <main>
        <form action="editar_solicitud" method="POST" class="registro-card form-user">
             <div class="titulo-seccion"><i class="fa fa-hand-holding-heart"></i> Editar Solicitud</div>
            <div class="fila-formulario">
                <div class="campo-formulario">
                    <label for="id_manual">Número de documento:</label>
                    <input type="text" id="id_manual" name="id_manual" placeholder="00004578" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" value="<?=$datos['id_manual'] ?? '' ?>">
                </div>
                <div class="campo-formulario">
                    <label for="descripcion">Descripción:</label>
                    <input type="text" id="descripcion" name="descripcion" placeholder="Ejem: Ayuda para silla de ruedas" required value="<?=$datos['descripcion'] ?? '' ?>">
                </div>
                <div class="campo-formulario">
                    <label for="ci">Cedula de Identidad:</label>
                    <input type="text" id="ci" name="ci" placeholder="Ejem: V-12345678" value="<?= htmlspecialchars($datos['ci'] ?? '')?>" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" readonly>
                </div>
            </div>
                ...
                <div class="campo-formulario">
                    ...
                    <select name="categoria" id="categoria" required>
                        <option value="">Seleccione</option>
                            ...
                            <option value="Economica" <?= ($datos['categoria'] ?? '') == 'Economica' ? 'selected' : '' ?>>Económica</option>
            ...
            <div class="fila-formulario">
                <div class="campo-formulario">
                    ...
                    <input type="text" id="observaciones_ayuda" name="observaciones" placeholder="Detalles relevantes (Opcional)" value="<?=$datos['observaciones'] ?? '' ?>">
                </div>
            </div>
