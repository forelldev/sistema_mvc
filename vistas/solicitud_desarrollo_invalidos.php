...
<body class="solicitud-body">
    <header class="header">
        ...
        <div class="header-right">
            ...
            <a href="<?=BASE_URL?>/solicitudes_desarrollo"><button class="nav-btn"><i class="fa fa-eye"></i> Ver Solicitudes Habilitadas</button></a>
        </div>
    </header>
    <main>
                ...
                <?php foreach ($datos as $fila): ?>
                    <div class="solicitud-card">
                        ...
                        <div class="solicitud-actions">
                            ...
                            <a href="<?= BASE_URL.'/habilitarDesarrollo?id_des='.$fila['id_des'] ?>" class="aprobar-btn">Habilitar</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
