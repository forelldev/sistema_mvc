...
<body class="solicitud-body bg-dark text-white">
  <!-- Header -->
  <header class="header bg-secondary border-bottom py-3 px-4 d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex gap-2">
      ...
      <?php $url = isset($direccion) && $direccion ? '/nueva_solicitud' : '/despacho_list'; ?>
  ...
  <main class="container py-5">
    <div class="card form-card text-white shadow-sm border-0 mx-auto" style="max-width: 480px;">
      <div class="card-body">
        <form action="<?= BASE_URL ?>/buscar_cidespacho" method="POST" autocomplete="off">
