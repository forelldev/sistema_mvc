...
<body style="background-color: #f1f3f5;">
  <div class="container my-5 px-4" >
    ...
    <a href="<?=BASE_URL?>/buscar_desarrollo" class="btn btn-outline-dark px-4 rounded-pill">
        ⬅️ Volver sin registrar
    </a>
      <form action="solicitudes_ciDesarrollo" method="POST" class="d-inline-block me-2">
